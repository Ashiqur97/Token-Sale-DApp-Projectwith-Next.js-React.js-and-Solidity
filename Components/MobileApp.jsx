            ...
            <div className="col-lg-7 col-md-12 col-sm-12">
                <div className="title_default_light title_border text_md_center">
                    ...
                    <p className="animation"
                      data-animation="fadeInUp"
                      ddata-animation-delay="0.2s"
                    >
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum omnis, 
                      eaque modi quasi autem eius molestiae iusto perspiciatis eos voluptatum minima quia, 
                      odit exercitationem quibusdam. Quod expedita cupiditate impedit natus!
                    </p>
